...
const (
	TAXOCLI_CONTENT_TYPE_REQ    = "application/json"
	TAXOCLI_TOKEN_API_URL       = "application/json"
	TAXOCLI_LATENCY_API_URL     = "application/json"
	TAXOCLI_LATENCY_TOKENS_COST = 5000
	TAXOCLI_API_THROTTLER_TIME  = 1
